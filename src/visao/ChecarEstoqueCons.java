 ...
 * @author Diogo
 */
public class ChecarEstoqueCons extends javax.swing.JDialog {

    /**
     * Creates new form ChecarEstoqueCons
     */
    public ChecarEstoqueCons(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.buscarProdutos();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Checar Estoque");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Produtos com estoque baixo"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChecarEstoqueCons.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ChecarEstoqueCons dialog = new ChecarEstoqueCons(new javax.swing.JFrame(), true);
    ...
    private void formatarColumnModel() {
    ...
    private void buscarProdutos() {
        ...
        listaProduto = produtoDao.selectEstoque();
