...
import visao.TableModel.MarcaColumnModel;
import visao.TableModel.MarcaTableModel;
...
public class MarcaCons extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jTxtParametroPesquisa = new javax.swing.JTextField();
        ...
        setTitle("Cosulta Marca");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Pesquisa"));

        JComboPesquisa.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        JComboPesquisa.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nome", "Id" }));
        JComboPesquisa.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));

        jTxtParametroPesquisa.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jTxtParametroPesquisa.setCursor(new java.awt.Cursor(java.awt.Cursor.TEXT_CURSOR));
        jTxtParametroPesquisa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTxtParametroPesquisaActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jTxtParametroPesquisa, javax.swing.GroupLayout.PREFERRED_SIZE, 249, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
        ...
        jTblMarca.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
    ...
    }//GEN-LAST:event_jTxtParametroPesquisaActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MarcaCons.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MarcaCons dialog = new MarcaCons(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTextField jTxtParametroPesquisa;
    ...
    private void formatarColumnTable() {
        ...
        jTblMarca.setColumnModel(new MarcaColumnModel(fm));
    }
    
    private MarcaTableModel model = new MarcaTableModel();
    private void setListaMarca(List<Marca> listaMarca) {
        this.jTblMarca.setModel(model);
        model.addListaDeMarca(listaMarca);
        this.formatarColumnTable();
    }
    
    public Marca getMarcaSelecionada() {
        return model.getMarca(jTblMarca.getSelectedRow());
    }
    
    private String param[] = new String[2];
    private void getParamentoPesquisa() {
        param[0] = JComboPesquisa.getSelectedItem().toString().toUpperCase();
        param[1] = jTxtParametroPesquisa.getText().toUpperCase();
    }
    
    private void botaoPesquisar() {
        getParamentoPesquisa();
    ...
    private void botaoNovo() {
        if (this.marcaFrm == null) {
            this.marcaFrm = new MarcaFrm(new JFrame(), true);
        }
        this.marcaFrm.setMarca(new Marca());
        this.marcaFrm.setVisible(true);
    }
    ...
    private void botaoEditar() {
        ...
        this.marcaFrm.setMarca(getMarcaSelecionada());
        this.marcaFrm.setVisible(true);
    }
